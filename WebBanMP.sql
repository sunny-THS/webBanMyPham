...
EXEC sp_AddSP N'Mascara Maybelline Volum’ Express Hyper', N'Công thức tối ưu kết hợp với đầu cọ được thiết kế dễ dàng chải tận gốc sợi mi, giúp mascara được bao phủ hiệu quả, cho bạn đôi mi dày ấn tượng, cong quyến rũ.', 20, 100000, N'Hàn Quốc', 'M3.jpg', N'Mascara'
